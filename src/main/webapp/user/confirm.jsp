            ...
            <div class="check-stup">
                ...
                <div class="pro-check check ">
	                ...
	                <table class="data-table cart-table" cellpadding="0" cellspacing="0">
						...
						<c:forEach items="${sessionScope.sorders}" var="sorder">
						<tr lang="${sorder.id}">
							<td width="80px"><img src="${shop }/upload/${sorder.product.pic}" width="80"
								height="80" />
							</td>
							<td class="align_left"><a class="pr_name" href="#">${sorder.product.pic},${sorder.name}</a>
							</td>
                    ...
                    <div class="sum"> 
                        <div class="fr"><span>总计：</span><b>￥${total}</b></div>
                    </div>
                ...
                <form action="order_save.action" method="post">
	                <div class="person-check check">
	                    ...
	                    <div class="person-checkinner">
	                        ...
	                        <div>
	                        	<label>区域邮编:</label>
	                        	<input type="text" name="post" value="43260"/>
	                        </div>
	                        <div>
	                        	<label>配送地址:</label>
	                        	<input type="text" name="address" value="anlu"/>
	                        </div>
	                    </div>
	                </div>
	                <!-- 卖家留言 -->
